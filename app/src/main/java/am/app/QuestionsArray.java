...
//Class containing the questions of the quiz

public class QuestionsArray {

    //Creates a array of strings containing the questions
    ...
    /*Returns the question depending on which number is given
    (either from the random or select modes)
    The number corresponds to the position of the question in the array*/
